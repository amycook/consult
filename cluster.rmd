...
p<- data.frame('Year' = all7d$Year, 'inv.mlsto'= all7d$inv.mlsto, 'balance.mlsto' = all7d$balance.mlsto,
               'cost.mlsto' = all7d$cost.mlsto, 'mlsto' = all7d$mlsto)
...
all7d<- merge(all7d, p %>% select(mlsto, adj.inv.mlsto, adj.balance.mlsto, adj.cost.mlsto) , by='mlsto')
all7d<- all7d %>% select(-inv.mlsto, - balance.mlsto, -cost.mlsto)
