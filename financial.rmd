...
profit <- function(df = all10mice, method = c("average","simp.log","simp.boost","orig.log","orig.rf","orig.boost"), 
        ...
        # saveRDS(joined, "/Users/yam/Documents/github/consult/finalwriteup/report_data/joined.rds")
        ...
        # saveRDS(compile.results, "/Users/yam/Documents/github/consult/finalwriteup/report_data/finance_results_simpboost.rds")
...
profit(df = all10mice, method = c("average","simp.log",'simp.boost', "orig.log","orig.rf","orig.boost"),
                   seed = 300,
                   k.folds = 5, # number of folds in initial model.blend generation
                   max.iter = 5, #max number of iterations from initial model.blend generation
                   k.folds.2 = 5, # number of folds for second step blended model development
...
saveRDS(plot.results,"C:/Users/n9232371/Documents/github/consult/finalwriteup/report_data/plot_finance_100_3.rds" )
saveRDS(plot.results,"/Users/yam/Documents/github/consult/finalwriteup/report_data/plot_finance_100_3.rds" )
