...
profit <- function(df = all10mice, method = c("average","simp.log","orig.log","orig.rf","orig.boost"), 
                   seed = 300, 
        ...
        df.blend = assemble(methods = c("log","rf","boost"), df.assem = df, x.folds.assem = 5,
                     manual.seed.assem = sample(1:1000,1))
        ...
        saveit <- iter.auc(mult = max.iter/k.folds.2, x.folds.iter = k.folds.2,
                           methods = c("orig.log","average","simp.log", "orig.rf","orig.boost"),
                           df.iter = df.blend)
        ...
        # saveRDS(compile.results, "C:/Users/n9232371/Documents/github/consult/finalwriteup/report_data/finance_results.rds")
...
# profit(df = all10mice, method = c("average","simp.log","orig.log","orig.rf","orig.boost"), 
#                    seed = 300, 
#                    k.folds = 5, # number of folds in initial model.blend generation
#                    max.iter = 5, #max number of iterations from initial model.blend generation
#                    k.folds.2 = 5, # number of folds for second step blended model development
...
# saveRDS(plot.results,"C:/Users/n9232371/Documents/github/consult/finalwriteup/report_data/plot_finance_100.rds" )
...
simp.l <- compile.results[['average']]
simp.l$mean.iter <- rowMeans(simp.l[,2:11])

saveRDS(simp.l, "C:/Users/n9232371/Documents/github/consult/finalwriteup/report_data/finance_average_model.rds")
