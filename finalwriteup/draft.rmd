...
* AUC for random forest, everything else without imputing?? thats what i did
    * boxplot showing AUC for all methods. how many runs, 20?
* only take best performing models and try with imputed data

* imputing - boosted trees still fine
    * apply to other methods
    
* boxplot chart showing AUC's for all methods on one plot : )

* table showing significance p value numbers - in comparison to what? the best performing one?
