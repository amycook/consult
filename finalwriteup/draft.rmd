...
* project profit
* return per dollar for each project (how much was spent on expnses for every dollar earned?)

Additional variables included in the project summary dataset were client information such as industry, discipline, job description, and post code. Once numerous potentially important variables were engineered, the most important ones can be narrowed down to reduce noise in the predictive models.
...
- need for statistical measurements
