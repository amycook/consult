...
* Highlighted as a major problem in previosu cost estimation studies
    * need to (1) communicate results usefully (2) trust
* User actions will vary, options listed in previous section: reject project, adjust contract structure
    * Communicate confidence
    * future work: probability: bayesian?
    * simple yes/no, easy, or on a scale of probability 0.6 to 1, but output is not statistically driven. score driven by machine learning algorithms.
    * future work: which is preferable user chooses
    

* Shiny App: engage user trust by two strategies
    * nearest neighbours
    * model output
