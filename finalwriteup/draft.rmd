...
Four model blending techniques were compared using the 8 variables determined above. These are FWLS, randomForest, boosted trees, simple averaging and were compared against logistic regression. Initially 20 train/test runs were performed for each method.
