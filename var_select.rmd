...
all7b<- all7a %>% select(return.pdol, no.users,timespan,mean.peeps,hours.perday,Num.disc,pc.pro,
                num.inv, pc.gradpro , inv.mlsto , client.numinv, client.totinv, client.meaninv , 
                client.neginv , mean.inv , pc.director , code.client , Post.Code , Billing.Type , 
                Discipline , Job.Detail.Primary , Job.Detail.Secondary , Job.Type.Primary , 
                Job.Type.Secondary , State , Type , Business , Biz.size , Biz.type , JD.Primary ,
                JD.Second , code.director , code.ProjEng , ProjEng.Pos , code.Eng2 , Eng2.Pos)
